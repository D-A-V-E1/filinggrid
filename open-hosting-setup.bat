...
echo     https://dashboard.render.com/blueprint/new?repo=https://github.com/D-A-V-E1/filinggrid
echo.
echo  2. Vercel frontend (import repo):
echo     https://vercel.com/new/clone?repository-url=https://github.com/D-A-V-E1/filinggrid
echo.
...
echo.
start "" "https://dashboard.render.com/blueprint/new?repo=https://github.com/D-A-V-E1/filinggrid"
timeout /t 2 >nul
start "" "https://vercel.com/new/clone?repository-url=https://github.com/D-A-V-E1/filinggrid"
endlocal
