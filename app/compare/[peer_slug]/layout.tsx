...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Side-by-side SEC filing footnote and MD&A comparison between ${tickers.join(", ")}. Fast, private ${year} 10-K and 10-Q disclosure workspace powered by FilingGrid.`;
